...
> ⚠️ **ملاحظة مهمة:** أرقام الإصدار المذكورة في هذا التقرير هي أرقام تاريخية لوقت إعداد التقرير — المرجع الحي والوحيد لرقم الإصدار الحالي هو [pubspec.yaml](../pubspec.yaml).

**التاريخ**: 2 ديسمبر 2025
**الإصدار**: 1.0.0 (تاريخي)
**Build Number**: 1 (تاريخي)
