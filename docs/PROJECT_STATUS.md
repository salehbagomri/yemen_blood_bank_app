...
> ⚠️ ملاحظة تاريخية: أرقام الإصدار وحالة الجاهزية في هذا الملف قديمة (سابقة لإعادة التعيين إلى 1.0.0+1 ولمراجعة الجودة الجارية). المرجع الوحيد للإصدار هو pubspec.yaml.
