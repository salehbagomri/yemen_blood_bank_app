...
- **الوصف:** رفع عبارة "صنع بحب لأهالي اليمن" والخط الفاصل للأعلى لتقليص المساحات الفارغة، وحذف عبارة "بواسطة Saleh Bagomri" بالكامل من الواجهة الرئيسية. وتحديث رقم الإصدار في شاشة "حول التطبيق" ليكون `1.0.0` بدلاً من `1.0.3` ليتناسب مع المتجر.
